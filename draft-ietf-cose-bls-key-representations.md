...
The following examples showcase JWKs for both the G1 and G2 subgroups of the Bls12381 curve. Note, those examples also include the corresponding private key, expressed through the inclusion of the “d” parameter.
